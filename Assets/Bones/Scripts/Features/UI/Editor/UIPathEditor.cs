...
namespace Features.UI
{
    ...
    public class UIPathEditor : Editor
    {
        ...
        Vector2 BlockDirectionMovement(Vector2 originalPoint, Vector2 direction, Vector2 desiredPosition)
        {
        ...
        private void PointHandle(ref PathPoint point, PathPoint? lastPoint, PathPoint? nextPoint, int index)
        {
            ...
            if (blocker.HasValue)
            {
                newPos = BlockDirectionMovement(position, blocker.Value, newPos);
            }
